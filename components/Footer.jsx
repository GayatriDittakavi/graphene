        ...
        <section className="py-32 text-white">
            <div className="container ">
                <footer className="w-screen">
                    <div className="grid grid-cols-3  gap-8 content-end">
                  ...
                  className="mb-4 h-7"
                /> */}
                            <span className="mb-80 h-7 text-2xl font-bold">Graphene</span>
                        ...
                        {/* <h2 className="mb-4 font-bold">Schedule a Demo</h2> */}
                        <button className="mx-auto no-underline group cursor-pointer relative shadow-2xl  rounded-full p-px text-xs font-semibold leading-6 text-white inline-block max-w-40 ">
