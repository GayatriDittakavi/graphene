        ...
        <div className=" p-4 max-w-7xl  mx-auto relative z-10  w-full pt-20 md:pt-0 max-md:pb-52">
          ...
          <div id="services" className="lg:flex-row mt-56 gap-32 flex-col flex justify-around items-center">
            <div className="flex flex-col gap-6 font">
              <h1
                className="text-4xl lg:text-5xl font-bold  bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50  pb-5 max-w-[65rem] max-sm:text-center font-sans">
          ...
          <img src="https://res.cloudinary.com/dafbhjsmx/image/upload/v1736509774/render_1-removebg-preview_bdw2ko.png" className='w-[40rem] h-[40rem] bg-purple-950 rounded-2xl max-lg:w-[30rem] max-lg:h-[30rem]' alt="" />
            <div className="flex flex-col gap-6 font">
              <h1
                className="text-4xl lg:text-5xl font-bold  bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50  pb-5 max-w-[50rem] max-sm:text-center font-sans">
