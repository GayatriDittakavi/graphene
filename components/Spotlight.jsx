        ...
        <div className=" p-4 max-w-7xl  mx-auto relative z-10  w-full pt-20 md:pt-0">
          ...
          <div id="services" className="lg:flex-row mt-56 gap-32 flex-col flex justify-around items-center">
            <div className="flex flex-col gap-6 font">
              <h1
                className="text-4xl lg:text-6xl font-bold  bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50  pb-5 max-w-[50rem] max-sm:text-center font-sans">
                Never Lose Track Again
              </h1>
              <span className="text-white text-xl font-sans lg:max-w-[40rem] xl:w-[50rem] pb-5 max-sm:text-center ">Hex One is the easiest way to keep tabs on your things. Attach one to your bag. Slip another into your wallet. And just like that, they&apos;re on your radar through a simple connection to your mobile, making it easy to track everything that matters. Whether it's your luggage, your tech, or anything in between, Hex One keeps you connected to what matters most. <br />
              </span>
              <span className="text-white text-xl max-w-[40rem] pb-5 max-sm:text-center ">Launching Soon.</span>
            </div>
            <img src="https://cdn.prod.website-files.com/644f5df7f9e72f4d074c8f00/6507ed863085cf26d118723f_Opendrone2-p-1600.webp" className='w-[40rem] h-[40rem] bg-blue-950 rounded-2xl' alt="" />
          </div>
          ...
          <div className="lg:flex-row mt-56 gap-32 flex-col flex justify-around items-center">
            ...
            <div className="flex flex-col gap-6 font">
              ...
              <span className="text-white text-xl font-sans lg:max-w-[40rem] xl:w-[50rem] pb-5 max-sm:text-center">Our IQTags, powered by our intuitive software, provide real-time tracking and automation, reducing errors and saving time. Gain valuable insights into product status, streamline inventory tracking, reduce loss, and enhance customer service—helping your business move beyond traditional methods with smarter, more efficient technology.</span>
            </div>
          </div>
