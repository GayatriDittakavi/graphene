        ...
        <div className=" p-4 max-w-7xl  mx-auto relative z-10  w-full pt-20 md:pt-0">
          ...
          <div id="services" className="md:flex-row mt-56 flex-col flex justify-around items-center">
            <div className="flex flex-col">
              <h1
                className="text-4xl font-bold  bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50 uppercase pb-5 max-w-[30rem] text-center">
            ...
            <img src="https://cdn.prod.website-files.com/644f5df7f9e72f4d074c8f00/6507ed863085cf26d118723f_Opendrone2-p-1600.webp" className='w-[30rem] h-[30rem] bg-blue-950 rounded-2xl' alt="" />
          </div>
          ...
          <div className="md:flex-row mt-56 flex-col flex justify-around items-center">
            ...
            <div className="flex flex-col">
              <h1
                className="text-4xl  font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50 uppercase pb-5 pt-5">
          ...
          <div className="md:flex-row mt-56 flex-col flex justify-around items-center">
            <div className="flex flex-col">
              <h1
                className="text-4xl  font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50 uppercase pb-5 ">
